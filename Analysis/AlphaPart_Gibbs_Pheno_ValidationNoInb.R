...
#=======================================================================
ebvPath <- "./Analysis/ModelOutputNoInb/all_solutions"
pedPath <- "./Analysis/ModelOutputNoInb/renadd01.ped"
...
p1/p2
ggsave("./Analysis/Results/EBV_TBV_ScenarioPhenoNoInb.pdf", 
       width = 9, height = 6)
#=======================================================================
# AlphaPart
#=======================================================================
...
m2 <- AlphaPart(dataEBV$data, colId = "ind", colFid = "father", 
                ...
                colBV = "tbv", 
                scaleEBV = list(center = TRUE, scale = TRUE))
saveRDS(m1, "./Analysis/Results/AlphaPart_EBV_ValidationPhenoNoInb.rds")
saveRDS(m2, "./Analysis/Results/AlphaPart_TBV_ValidationPhenoNoInb.rds")
...
save(SMean, file = "./Analysis/Results/SMean_TBV_ValidationPhenoNoInb.rds")
...
SVar <- wrapperSummary(m1 = m1, m2 = m2, ncols = 1500,
                       ...
                       levels=c("F", "F:M(N)", "F:M(S)", "M(N)", 
                                "M(N):M(S)", "M(S)", "Sum"))
save(SVar, file = "./Analysis/Results/SVar_TBV_ValidationPhenoNoInb.rds")
#load("./Analysis/Results/SMean_TBV_ValidationPhenoNoInb.rds")
#load("./Analysis/Results/SVar_TBV_ValidationPhenoNoInb.rds")
