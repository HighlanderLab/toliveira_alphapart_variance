...
for(i in 1:30){
  cat("rep", i, "\n")
  load(paste0(
    "./Analysis/Supplementary/30_Replicates25Sires/Results/SMean_TBV_ValidationPheno", 
    i,".rds"))
...
ggsave("./Analysis/Supplementary/30_Replicates25Sires/Figures/diffMeanPheno.pdf", 
       width = 7, height = 7)
...
data %>%
  ...
  geom_vline(xintercept = 0, linetype = 2, alpha = 0.2) +
  theme_bw(base_size = 14)
ggsave("./Analysis/Supplementary/30_Replicates25Sires/Figures/diffMeanMSTPheno.pdf", 
       width = 7, height = 7)
...
for(i in 1:30){
  cat("rep", i, "\n")
  load(paste0(
    "./Analysis/Supplementary/30_Replicates25Sires/Results/SVar_TBV_ValidationPheno", 
    i,".rds"))
...
data %>%
  ...
  geom_hline(yintercept = 0, linetype = 2, alpha = 0.4, colour = "blue") +
  theme_bw(base_size = 14)
ggsave("./Analysis/Supplementary/30_Replicates25Sires/Figures/diffVarPheno.pdf", 
       width = 7, height = 7)
...
for(i in 1:30){
  cat("rep", i, "\n")
  load(paste0(
    "./Analysis/Supplementary/30_Replicates25Sires/Results/SMean_TBV_ValidationTBV", 
    i,".rds"))
  tmp <- inner_join(SMean[[1]], SMean[[2]], 
                    by = c("generation" = "generation", "path" = "path"))
  tmp <- tmp %>%
...
data %>%
  ...
  ylim(-3.5, 1.5) +
  theme_bw(base_size = 14)
ggsave("./Analysis/Supplementary/30_Replicates25Sires/Figures/diffMeanTBV.pdf", 
       width = 7, height = 7)
...
data %>%
  ...
  ylim(-1.1, 0.6) +
  theme_bw(base_size = 14)
ggsave("./Analysis/Supplementary/30_Replicates25Sires/Figures/diffMeanMSTTBV.pdf", 
       width = 7, height = 7)
...
for(i in 1:30){
  cat("rep", i, "\n")
  load(paste0(
    "./Analysis/Supplementary/30_Replicates25Sires/Results/SVar_TBV_ValidationTBV", 
    i,".rds"))
  tmp <- inner_join(SVar[[1]], SVar[[2]], 
                    by = c("generation" = "generation", "path" = "path"))
  tmp <- tmp %>%
...
data %>%
  ...
  ylim(-0.25, 0.25) +
  theme_bw(base_size = 14)
ggsave("./Analysis/Supplementary/30_Replicates25Sires/Figures/diffVarTBV.pdf", 
       width = 7, height = 7)
