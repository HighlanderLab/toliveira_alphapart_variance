...
#=======================================================================
source("./Analysis/Supplementary/30_Replicates/CommonFunctions.R")

#=======================================================================
# Organizing gibbs1f90 database
#=======================================================================
cat("Reading data", "\n")
ebvPath <- "./Analysis/Supplementary/30_Replicates/ModelOutput/all_solutions"
pedPath <- "./Analysis/Supplementary/30_Replicates/ModelOutput/renadd01.ped"
dataPath <- paste0("./Results/Scenario1_replicate", r, ".rds")
...
save(SMean, 
     file = paste0("./Analysis/Supplementary/30_Replicates/Results/SMean_TBV_ValidationPheno", r,
                   ".rds"))
...
SVar <- wrapperSummary(m1 = m1, m2 = m2, ncols = 1500,
                       ...
                       levels=c("F", "F:M(N)", "F:M(S)", "M(N)", 
                                "M(N):M(S)", "M(S)", "Sum"))
save(SVar, 
     file = paste0("./Analysis/Supplementary/30_Replicates/Results/SVar_TBV_ValidationPheno", r, 
                   ".rds"))
